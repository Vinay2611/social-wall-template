                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                //
                                $sql = "SELECT uc.user_comment_id,uc.user_post_id,uc.comments,uc.status,u.first_name,u.last_name,u.email_id,up.caption,up.user_post_id  FROM `users_comment` AS uc JOIN users AS u on uc.user_id = u.user_id JOIN users_post AS up ON up.user_post_id = uc.user_post_id WHERE u.status = 'Active' ORDER BY up.caption, uc.createdon DESC";
                                ...
                                while ($row = $que->fetch_assoc()){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-danger btn-xs userComment" data-id="<?php echo $row['user_comment_id']; ?>">Reject</a>
                                        <?php }else{ ?>
                                            <a href="javascript:void(0);" class="btn btn-primary btn-xs userComment" data-id="<?php echo $row['user_comment_id']; ?>">Accept</a>
                                        <?php } ?>
                                        </td>
                                    </tr>
                                    <?php
