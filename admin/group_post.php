                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title pull-right"><a href="group_post_report.php" class="btn btn-success ">Download report</a></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $sql = "SELECT u.first_name,u.last_name,u.email_id,up.image,up.caption,up.status,up.user_post_id,up.group_id,up.createdon FROM `users_post` AS up JOIN  users AS u on up.user_id = u.user_id WHERE u.status = 'Active' ORDER BY up.createdon desc";
                                $que = $db2->query( $sql );
                                if($que->num_rows > 0) {
                                    $i = 0;
                                    while ($row = $que->fetch_assoc()){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-danger btn-xs groupUserPost" data-id="<?php echo $row['user_post_id']; ?>">Reject</a>
                                            <?php }else{ ?>
                                                <a href="javascript:void(0);" class="btn btn-primary btn-xs groupUserPost" data-id="<?php echo $row['user_post_id']; ?>">Accept</a>
                                            <?php } ?>
                                            <?php //echo $row['status']; ?>
                                            </td>
                                            <td>
                                                <a href="view_group_post.php?id=<?php echo $row['user_post_id']; ?>" class="btn btn-info btn-xs" > view</a></td>
                                            </td>
                                        </tr>
                                        <?php
                                    }
