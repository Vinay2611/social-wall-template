                    ...
                    <ul>
                        ...
                        <li style="border-left: none">
                            ...
                            if($sql_quer_like->num_rows > 0) {
                                ?>
                                <i class="fas fa-heart click-unlike" id="unlike_<?php echo $user_post_id; ?>" data-user-id="<?php echo $user_post_id; ?>"></i> <span id="count_unlike_<?php echo $user_post_id; ?>"><?php echo $count_like; ?></span>
                                <!--<span id="response_msg_unlike" style="display: none">You un-like this post</span>-->
                                <?php
                            }else{
                            ?>
                                <i class="far fa-heart click-like" id="like_<?php echo $user_post_id; ?>" data-user-id="<?php echo $user_post_id; ?>"></i> <span id="count_like_<?php echo $user_post_id; ?>"><?php echo $count_like ?></span>
