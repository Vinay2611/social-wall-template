                ...
                <div class="row">
                    <div class="col-md-4 col-lg-offset-4">
                        ...
                        <select name="group_id" id="group_id" class="form-control">
                            ...
                            <option value="23">Tata Steel  - AA</option>
                            <option value="24">Tata  Sponge - AA</option>
                            <option value="25">JUSCO - AA</option>
                            <option value="26">Tata Capital - AA</option>
                            <option value="27">Tata Metaliks - AA</option>
                            <option value="28">Tata Communications - AA</option>
                            <option value="29">Tata Global Beverages - AA</option>
                            <option value="30">Tata Projects - AA</option>
                            <option value="31">Tinplate - AA</option>
                            <option value="32">Tata Power - AA</option>
                            <option value="33">ISWP - AA</option>
                        </select>
                    </div>
...
<script>
    /*$(function () {
        var options = $("#group_id option");                    // Collect options
        options.detach().sort(function(a,b) {               // Detach from select, then Sort
            var at = $(a).text();
            var bt = $(b).text();
            return (at > bt)?1:((at < bt)?-1:0);            // Tell the sort function how to order
        });
        options.appendTo("#group_id");
    });*/
    ...
    jQuery(document).ready(function() {
        ...
        $('#group_id option').sort(NASort).appendTo('#group_id');
        $('#group_id option[value=0]').attr('selected','selected');

        /*The default selected value is moved to the top*/

        //$('#group_id option:eq(0)').insertBefore('#group_id option:eq(0)');
